...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		...
		<div class='judul'>OPMI Kota Batu Support By <a href="#" class="txt2 hov1">
										<b>Dee</b> V<?php echo $setting['versi']; ?>
									</a></div>
		...
		<div class="login100-more" style="background-image:url('<?php echo "$homeurl/$setting[background_admin]";?>');"></div>
