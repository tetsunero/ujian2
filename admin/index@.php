     ...
     filter:progid:DXImageTransform.Microsoft.BasicImage(rotation=3);
				...
				<div class='wrapper'>
							...
							<ul class=' sidebar-menu tree data-widget='tree' >
								...
								if($pengawas['level']=='admin') {
									...
									<li class=' treeview'>
										...
										<li><a href='?pg=laporan'><i class='fa  fa-circle-o text-red'></i> <span>Laporan Nilai</span></a></li>
										</ul>
										</li>
										<li class='treeview'><a href='?pg=editnilai'><i class='fa  fa-user-secret'></i> <span> Perbaikan Nilai</span></a></li>
										<li class='treeview'><a href='?pg=anso'><i class='fa  fa-user-secret'></i> <span> Analisa Soal</span></a></li>
										<li class='treeview'><a href='?pg=rekapwali'><i class='fa  fa-user-secret'></i> <span> Rekapitulasi Nilai</span></a></li>
								...
								<li class='header text-center' id='end-sidebar'>TIM IT SMPN 234</b> @ 2019</li>
							</ul><!-- /.sidebar-menu -->
						</section>
					</aside>
					...
					<section class='content-header'>
						...
						if(isset($_POST['simpanwali'])){
							$kodew=str_replace(' ', '',$_POST['idwali']);
							$kode=str_replace(' ', '',$_POST['id_pengawas']);
							$namakelas=addslashes($_POST['id_kelas']);
							$cek=mysql_num_rows(mysql_query("select * from walikls where idwali='$kodew'"));
							if($cek==0){
							$exec=mysql_query("INSERT INTO walikls (idwali,id_pengawas,id_kelas)value('$kodew','$kode','$namakelas')");
										...
										<div class='box box-primary'>
											<div class='box-header with-border'>
												...
												<div class='box-tools pull-right btn-group'>
													<button class='btn btn-sm btn-primary' data-toggle='modal' data-target='#tambahwali'><i class='fa fa-check'></i> Tambah Wali</button>
											...
											<div class='table-responsive'>
												<table id='tablewali' class='table table-bordered table-striped'>
													<thead>
														<tr>
															<th width='5px'>#</th>
															<th>Wali kelas</th>
													...
													echo "
															...
															<div class='modal fade' id='tambahwali' style='display: none;'>
															<div class='modal-dialog'>
															<div class='modal-content'>
															<div class='modal-header bg-blue'>
															<button  class='close' data-dismiss='modal'><span aria-hidden='true'><i class='glyphicon glyphicon-remove'></i></span></button>
															<h3 class='modal-title'>Tambah Wali Kelas</h3>
															</div>
															...
															<div class='form-group'>
																...
																$walikelas = mysql_query("SELECT * from pengawas");	
															...
															<div class='form-group'>
																...
																while($wali = mysql_fetch_array($walikelas)) {
																	...
																	echo "<option value='$wali[nama]'>$wali[nama]</option>";
																}
																echo"
																</select>
															</div>
															...
															<div class='box-tools pull-right btn-group'>
																<button type='submit' name='simpanwali' class='btn btn-sm btn-success'><i class='fa fa-check'></i> Simpan</button>
            ...
            echo "
                ...
                ";
						...
						<tr>
						<td rowspan='4' width='120' align='center'><img src='$homeurl/foto/logo47.png' width='80'></td>
						...
						<td width='5px'>&nbsp;</td>
						<td style='border:1px solid black;font-weight:bold;font-size:14px;text-align:center;'>DINAS PENDIDIKAN PROVINSI DKI JAKARTA</td>
						<td width='5px'>&nbsp;</td>
						<td width='25px' style='border:1px solid black'></td>
						</tr>
						</tbody>
