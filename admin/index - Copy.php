	...
	($pg=='nilai' && $ac=='lihat' ) ? $sidebar = 'sidebar-collapse' : $sidebar = '';
						$nilai = mysql_num_rows(mysql_query("SELECT * FROM nilai"));
							...
							$token = mysql_num_rows(mysql_query("SELECT * FROM token"));
	echo "
		<!DOCTYPE html>
		<html>
			<head>
			...
			<div class='loader'></div>
				<div class='wrapper'>
							...
							<ul class=' sidebar-menu tree data-widget='tree' >
								...
								if($pengawas['level']=='admin') {
									...
									<li class=' treeview'>
										...
										<li class='treeview'><a href='?pg=editnilai'><i class='fa  fa-check-circle-o'></i> <span> Perbaikan Nilai</span></a></li>
										<li class='treeview'><a href='?pg=anso'><i class='fa  fa-check-square'></i> <span> Analisa Soal</span></a></li>
										<li class='treeview'><a href='?pg=rekapnilai'><i class='fa  fa-user-o'></i> <span> Rekapitulasi Nilai</span></a></li>
								...
								<li class='header text-center' id='end-sidebar'>TIM IT $setting[sekolah]</b> @ 2019</li>
							</ul><!-- /.sidebar-menu -->
						</section>
					</aside>
					...
					<section class='content-header'>
							...
							echo "
								...
								<div class=' row'>
									...
									<div class='  col-md-8'>
										...
										<a href='?pg=reset'><div class='info-box'>
										...
										<div class='animated swing col-md-4'>
										<a href='?pg=status'><div class='info-box'>
											<span class='info-box-icon bg-maroon'><i class='fa fa-ticket'></i></span>
											<div class='info-box-content'>
												<span class='info-box-text'>STATUS PESERTA</span>
												<span class='info-box-number'>$ket</span>
											</div><!-- /.info-box-content -->
										</div></a><!-- /.info-box -->
										</div>
										...
										<div class='animated swing col-md-4'>
										<a href='?pg=token'><div class='info-box'>
											<span class='info-box-icon bg-navy'><i class='fa fa-barcode'></i></span>
											<div class='info-box-content'>
												<span class='info-box-text'>RILIS TOKEN</span>
												<span class='info-box-number'>$token</span>
											</div><!-- /.info-box-content -->
										</div></a><!-- /.info-box -->
										</div>
						...
						<tr>
						<td rowspan='4' width='140' align='center'><img src='$homeurl/dist/img/logo12.png' width='80'></td>
