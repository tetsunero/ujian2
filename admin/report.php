		...
		if ($i==$n){
			...
			<div class='page'>
						...
						<td>
							<CENTER>
								<strong class='f12'>
									...
									$setting[nama_ujian] <BR>$setting[sekolah]<BR>TAHUN PELAJARAN $ajaran
								</strong>
							</CENTER></td>
				...
				<tr height=40px>
					...
					<th width='17%'><center>No Peserta</center></th>
					<th><center>Nama</center></th>
					<th width='7%'><center>NPG</center></th>
					<th width='7%'><center>NEssai</center></th>
				...
				<tr>
					...
					<td>
						<CENTER>
							<strong class='f12'>
								REKAPITULASI NILAI <BR>
								$setting[nama_ujian] $setting[sekolah]<BR>TAHUN PELAJARAN $ajaran
							</strong>
						</CENTER></td>
						<td width='100'><img src='$homeurl/$setting[logo]' height='75'></td>
				</tr>
