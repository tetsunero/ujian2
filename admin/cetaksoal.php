		...
		<html>
			...
			<body>
				...
				<table width='100%'>
					...
					<table class='detail'>
					<tr>
						<td>SEKOLAH/MADRASAH</td><td>:</td><td><span style='width:350px;'>&nbsp;$namasekolah[sekolah]</span></td>
						<td>Tingkat | Jurusan </td><td>:</td><td><span style='width:150px;'>&nbsp;$mapel[level] | $jurusan ]</span></td>
					</tr>
					<tr>
						<td>PEMBUAT SOAL</td><td>:</td><td><span style='width:350px;'>&nbsp;$guru[nama]</span></td>
						
						<td>MAPEL</td><td>:</td><td colspan='4'><span style='width:150px;'>&nbsp;$mapel[nama] </span></td>
					</tr>
			...
			while($sp = mysql_fetch_array($sql))
			{
				...
				echo "
					...
					<tr>											
						...
						<tr>
						<td width=30px valign=top>&nbsp;</td>
						<td width=300px colspan=2 valign=top><b>Jawaban: $sp[jawaban]</b></td>
						</tr>
						</table>
						";
				}
